...
+==========+===========+===============+=========================================================================================+
| 8.x      | 6.2       | 3.10 - 3.14   | Switch to PEP 420 (native namespace packages)                                           |
+----------+-----------+---------------+-----------------------------------------------------------------------------------------+
| 7.x      | 6.0 - 6.2 | 3.9 - 3.14    | Support for 6.2 and Python 3.14 is not declared in the classifiers, but it should work. |
+----------+-----------+---------------+-----------------------------------------------------------------------------------------+
